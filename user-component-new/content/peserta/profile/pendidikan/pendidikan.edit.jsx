...
const PendidikanEdit = ({ funcViewEdit, token, wizzard }) => {
        ...
        return (
            <components.NoOptionsMessage {...props}>
                <p className="text-left">
                    Silahkan pilih Nama Institusi Pendidikan Lainnya bila Nama
                    Institusi Pendidikan Anda tidak muncul..
                </p>
    ...
    const handleSubmit = (e) => {
        ...
        if (jengjangPendidikan.label.includes("SMA")) {
            simpleValidator.current.fields["program studi"] = true;
            simpleValidator.current.fields["ipk"] = true;
            simpleValidator.current.fields["lainya ( sekolah/ pt )"] = true;
            simpleValidator.current.fields["nama institusi"] = true;
        }
        ...
        if (
            ...
            simpleValidator.current.fields["lainya ( sekolah/ pt )"] = true;
            simpleValidator.current.errorMessages["lainya ( sekolah/ pt )"] =
                null;
        }
                        ...
                        showInputCollegeName === false && (
                            <Row>
                                ...
                                >
                                    ...
                                    <Form.Control
                                        placeholder={
                                            "Silahkan Masukkan Program Studi"
                                        }
                                        value={
                                            programStudi === "0"
                                                ? "-"
                        ...
                        showInputCollegeName === true && (
                            <Row>
                                ...
                                >
                                    ...
                                    <Form.Control
                                        placeholder={
                                            "Silahkan Masukkan Nama Institusi Pendidikan"
                                        }
                                        value={asalInstitusi}
                                        onChange={(e) =>
                                            setAsalInstitusi(e.target.value)
                                        }
                                        onBlur={() =>
                                            simpleValidator.current.showMessageFor(
                                                "nama institusi"
                        ...
                        <Row className="mb-3">
                            ...
                            >
                                ...
                                <span className="text-muted">
                                    Masukkan Maksimal dan Minimal 4 Angka,
                                    Contoh : 2020
                                </span>
                                {simpleValidator.current.message(
                                    "tahun masuk",
                        ...
                        showInputCollegeName === false && (
                            <Row className="mb-3">
                                ...
                                >
                                    ...
                                    />
                                    <span className="text-muted">
                                        Gunakan titik "." dengan dua angka di
                                        belakang titik - Contoh : 3.75
                                    </span>
                                    {/* {
                  errorOnIpk === true ? 

                ...
                <div className="brand flex-column-auto" id="kt_brand">
                    ...
                    <button
                        className={`brand-toggle btn btn-sm px-0 ${
                            allFunctionls.isMinimizeSidebar &&
                            allFunctionls.isMinimizeSidebar
                                ? 'active'
                                : ''
                        }`}

    ...
    const handleActiveSubmenu = (
        ...
        if (status === "parent") {
            ...
            if (iSubSubMenu === null) {
                ...
                _temp[iMenu].child[iSubMenu].child[iSubSubMenu].selected =
                    !condition;
            }
        } else {
            _temp[iMenu].selected = true;
        ...
        >
            ...
            >
                ...
                >
                    {!session ? (
                        ""
                    ) : session?.user?.user?.data?.user?.roles[0] ===
                      "mitra" ? (
                        <ul className="menu-nav">
                            <p className="fz-12 fw-400 text-white ml-4">
                                Partnership
                            </p>
                            <li

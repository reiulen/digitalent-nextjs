            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <p className="text-neutral-body">
                  {moment(dataPelatihan.pendaftaran_mulai)
                    .utc()
                    .format("DD MMMM YYYY")}{" "}
                  Sampai{" "}
                  {moment(dataPelatihan.pendaftaran_selesai)
                    .utc()
                    .format("DD MMMM YYYY")}{" "}
                </p>
              </div>
                              ...
                              <span
                                className={
                                  ...
                                  (row.administrasi === "verified" &&
                                    "label label-inline statusPeserta-success font-weight-bold") ||
                                  (row.administrasi === "incomplete" &&
                                    "label label-inline statusPeserta-danger font-weight-bold")
                                }
                              >

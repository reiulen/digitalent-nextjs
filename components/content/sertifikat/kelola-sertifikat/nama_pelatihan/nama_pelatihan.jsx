...
export default function NamaPelatihanID({ token }) {
    ...
    const publishedCertificate = useSelector(
    ...
    useEffect(() => {
        if (
            allOptionTheme.theme &&
            Object.keys(allOptionTheme.theme).length != 0
        ) {
    ...
    const handleLimit = (val) => {
        ...
        router.push(
            ...
            }?id=${router.query.id || ""}&page=1&limit=${val}`
        );
    };
    ...
    const handleFilter = (e) => {
        if (!status) {
            Swal.fire(
                "Oops !",
                "Harap memilih Status terlebih dahulu.",
                "error"
            );
        } else {
                    ...
                    >
                      Cari
                        ...
                        <div className="table-page mt-5">
                                ...
                                {loading === false ? (
                                    <table className="table table-separate table-head-custom table-checkable">
                                        ...
                                        <tbody>
                                            ...
                                            certificates.data.pelatihan.list
                                                .length === 0 ? (
                                                <tr>
                                                    <td
                            ...
                            <div className="row">
                                {certificates &&
                                    certificates?.data?.pelatihan?.total >
                                        5 && (
                                        <div className="table-pagination col">
                                            <Pagination
                                                activePage={+page}
                                                itemsCountPerPage={
                                                    certificates.data.pelatihan
                                                        .perPage
                                                }
                                                totalItemsCount={
                                                    certificates.data.pelatihan
                                ...
                                {certificates &&
                                certificates?.data?.pelatihan?.total > 5 ? (
            ...
            >
                ...
                <Modal.Body>
                    <Fragment>
                        ...
                        {cloneData?.certificate?.certificate_type ==
                            "2 lembar" &&

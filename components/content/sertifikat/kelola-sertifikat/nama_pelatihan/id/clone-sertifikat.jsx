...
export default function EditSertifikat({ token }) {
  ...
  const { certificate: mainCertificate } = useSelector(
    (state) => state.detailCertificates
  );

  const { certificate } = useSelector((state) => state.publishCertificate);
  ...
  const handlePost = async (e, status) => {
    try {
      ...
      // academy_id}/${id.theme_id}/${id.training_id
                      ...
                      >
                        ...
                        <div className=" w-100">
                          ...
                          <span className="font-weight-bold w-100">
                            {pelatihanDetail?.akademi || "Nama Pelatihan"}{" "}
                          </span>{" "}
                        </div>
                        <div>

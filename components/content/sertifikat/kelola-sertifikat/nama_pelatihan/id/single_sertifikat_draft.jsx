                ...
                >
                  <div className="p-0" style={{ height: "595px" }}>
                    {certificate.data.certificate.background ? (
                      <Image
                        src={`${process.env.END_POINT_API_IMAGE_SERTIFIKAT}images/background/${certificate.data.certificate.background}`}
                        alt="fitur"
                        layout="fill"
                        objectFit="fill"
                      />
                              ...
                              >
                                <div className="col p-0">
                                  ...
                                  >
                                    {el.signature ? (
                                      <Image
                                        src={`${process.env.END_POINT_API_IMAGE_SERTIFIKAT}images/signature-certificate-images/${el.signature}`}
                                        layout="fill"
                  ...
                  <div className="border-primary p-0 border col-lg-8 col-12 position-relative">
                    <div className="p-0">
                      {certificate.data.certificate.background_syllabus ? (
                        <Image
                          src={`${process.env.END_POINT_API_IMAGE_SERTIFIKAT}images/background-syllabus/${certificate.data.certificate.background_syllabus}`}
                          alt="fitur"
                          layout="fill"
                          objectFit="fill"
                        />
                                ...
                                >
                                  <div className="col">
                                    ...
                                    >
                                      {el.signature ? (
                                        <Image
                                          src={`${process.env.END_POINT_API_IMAGE_SERTIFIKAT}images/signature-certificate-image-syllabus/${el.signature}`}
                                          layout="fill"
                                          alt={`Tanda tangan ${i + 1} `}
                                        />
                                      ) : (

      ...
      <PageWrapper>
        <div className="row">
          ...
          <div className="col-lg-6 col-xxl-6 order-1 order-xxl-2">
            ...
            <div
              className="card card-custom pb-0"
              style={{
                background: "#0BB783",
                backgroundImage: "url('/assets/media/human1.svg')",
                backgroundRepeat: "no-repeat",
              ...
              <div className="row">
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    >
                      Tambah Tes <br /> Substansi klik <br /> Tombol dibawah
                    </p>
            ...
            <div className="row h-100">
              <div className="col-md-6">
                <div
                  ...
                  style={{
                    background: "#C9F7F5",
                    backgroundImage: "url('/assets/media/human2.svg')",
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: "right bottom",
                ...
                >
                  <div className="row">
                    <div className="card-body">
                      ...
                      >
                        Tambah Survey ? <br /> Klik Tombol <br /> dibawah
                      </p>
              ...
              <div className="col-md-6">
                <div
                  className="card card-custom h-100 p-5"
                  style={{
                    background: "#8950FC",
                    backgroundImage: "url('/assets/media/human3.svg')",
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: "right bottom",
                ...
                >
                  <div className="row">
                    <div className="card-body">
                      ...
                      >
                        Klik tombol dibawah <br /> ini untuk tambah <br />{" "}
                        TRIVIA
                      </p>

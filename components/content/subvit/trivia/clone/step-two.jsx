...
import { deleteCloneTriviaQuestionBanks } from "../../../../../redux/actions/subvit/trivia-question.actions";
import { DELETE_TRIVIA_QUESTION_DETAIL_RESET } from "../../../../../redux/types/subvit/trivia-question-detail.type";
import { DELETE_CLONE_TRIVIA_QUESTION_BANKS_RESET } from "../../../../../redux/types/subvit/trivia-question.type";
...
const StepTwo = ({ token, tokenPermission }) => {
  ...
  useEffect(() => {
    ...
    if (isDeleted) {
      ...
      dispatch({
        type: DELETE_CLONE_TRIVIA_QUESTION_BANKS_RESET,
      });
    }
  ...
  const handleCheckboxDeleteAll = (e) => {
    if (e.target.checked) {
      let arr = checkedDelete;
      trivia_question_detail.list_questions.forEach((row) => {
      ...
      trivia_question_detail.list_questions.forEach((row, i) => {
  ...
  const handleDeleteAll = () => {
    ...
    dispatch(deleteCloneTriviaQuestionBanks(data, token, tokenPermission));
  };
                          ...
                          (question, i) => {
                            return (
                              <tr key={question.id}>
                                ...
                                <td className="align-middle">
                                  CC{question.trivia_question_bank_id}
                                </td>
                                <td className="align-middle">
                                  {question.question}
                                </td>

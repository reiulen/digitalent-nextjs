...
const TriggeredQuestionComponent = ({ propsAnswer, propsStatus, sendPropsAnswer, sendPropsStatus }) => {
    ...
    return (
        <>
                            ...
                            <>
                                <div className="title row">
                                    ...
                                    <div className="col-md-3 d-flex justify-content-start my-auto">
                                        {
                                            i !== 0 ? (
                                                <button className="btn pt-0 mr-3 mt-5" type='button' onClick={() => handleRemoveClick(null, null, i)}>
                                                    <Image
                                                        alt="button-action"
                                            ...
                                            row.sub.map((rowY, j) => {
                                                return <>
                                                    ...
                                                    <div className="col-md-3 d-flex justify-content-start my-auto">
                                                        {
                                                            j !== 0 ? (
                                                                <button className="btn pt-0 mr-3 mt-5" type='button' onClick={() => handleRemoveClick(null, i, j)}>
                                                                    <Image
                                                                        alt="button-action"
                                                                        src="/assets/icon/trash-red.svg"
                                                                        width={20}
                                                            ...
                                                            rowY.answer.map((rowX, k) => {
                                                                return <>
                                                                    <div className="col-md-3"></div>
                                                                    {
                                                                        rowX.type === 'choose' ? (
                                                                            <>
                                                                                <div className="col-md-2 p-0 pl-3" key={k}>
                                                                                    <Image src='/assets/media/Gambar.svg' alt='logo' width={148} height={90} />
                                                                                </div>
                                                                                <div className="col-md-4 pt-2">
                                                                                    <input
                                                                                        ...
                                                                                        value={rowX.option}
                                                                                        onChange={e => handleInputChange(e, i, j, k)}
                                                                                        autoComplete='off'
                                                                                    />
                                                                                    <div className="custom-file mt-2">
                                                                                        <span>Gambar Pertanyaan (Opsional)</span>
                                                                    ...
                                                                    <div className="col-md-3 d-flex justify-content-start my-auto">
                                                                        {
                                                                            k !== 0 ? (
                                                                                <button className="btn pt-0 mr-3" type='button' onClick={() => handleRemoveClick(i, j, k)}>
                                                                                    <Image
                                                                                        alt="button-action"
                                                                                        src="/assets/icon/trash-red.svg"
                                                                                        width={20}
                                                    ...
                                                    <div className="col-sm-9 col-md-9 d-flex">
                                                        {rowY.answer.length < 6 ? (
                                                            <>
                                                                <button type='button' className="btn btn-light-success font-weight-bold btn-sm mr-2 my-3" onClick={() => handleAddClick("choose", i, j)}>Tambah Jawaban</button>
                                                                {
                                                                    rowY.answer.length > 2 ? (
                                                                        <>
                                                                            <button type='button' className="btn btn-light-success font-weight-bold btn-sm my-3" onClick={() => handleAddClick("empty", i, j)}>Tambah Jawaban Lain</button>
                                                                        </>
                                                                    ) : ''
                                                                }
                                                            </>
            ...
            {answer.length < 6 ? (
                <>
                    <button type='button' className="btn btn-light-success font-weight-bold mr-2 my-3" onClick={() => handleAddClick("choose", null, null)}>Tambah Jawaban</button>
                    {
                        answer.length > 2 ? (
                            <>
                                <button type='button' className="btn btn-light-success font-weight-bold" onClick={() => handleAddClick("empty", null, null)}>Tambah Jawaban Lain</button>
                            </>
                        ) : ''
                    }
                </>
            ...
            <div className="form-group row">
                <div className="col-sm-12 col-md-5">
                    ...
                    <select
                        name="training_id"
                        className="form-control"
                        onChange={(e) => { setStatus(e.target.value); sendPropsStatus(e.target.value) }}
                        onBlur={e => { setStatus(e.target.value); sendPropsStatus(e.target.value) }}
                        value={status}
                    >

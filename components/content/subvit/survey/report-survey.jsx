    ...
    return (
        <PageWrapper>
            ...
            <div className="col-lg-12 col-md-3">
                <div className="row">
                    <CardPage background='bg-light-info' icon='orang-tambah-purple.svg' color='#8A50FC' value='90' titleValue='' title='Total Peserta' />
                    <CardPage background='bg-light-success' icon='done-circle.svg' color='#0BB783' value='64' titleValue='' title='Sudah Mengerjakan' />
                    <CardPage background='bg-light-warning' icon='book-open.svg' color='#634100' value='64' titleValue='' title='Sedang Mengerjakan' />
                    <CardPage background='bg-accent-info' icon='mail-purple.svg' color='#663259' value='64' titleValue='' title='Belum Mengerjakan' />
                ...
                <div className="card card-custom card-stretch gutter-b pt-3">
                    <div className="card-header border-0 align-items-center row">
                        <div className="col-lg-10 col-xl-10">
                            <h3 className="card-title font-weight-bolder text-dark">Report Survey</h3>
                            ...
                            <div className="row align-items-center my-5">
                                <div className="col-lg-3 col-xl-3 ">
                                    <div className="form-group mb-0">
                                        ...
                                        <small className="text-muted mt-1 p-0">Filter by Pelatihan</small>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-xl-3 ">
                                    <div className="form-group mb-0">
                                        ...
                                        <small className="text-muted mt-1 p-0">Filter by Status</small>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-xl-3 ">
                                    <div className="form-group mb-0">
                                        ...
                                        <small className="text-muted mt-1 p-0">Filter by Nilai</small>
                                    </div>
                                </div>
                            </div>
                        </div>

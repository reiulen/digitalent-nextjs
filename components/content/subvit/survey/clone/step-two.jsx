...
import { deleteCloneSurveyQuestionBanks } from "../../../../../redux/actions/subvit/survey-question.actions";
import { DELETE_SUBTANCE_QUESTION_DETAIL_RESET } from "../../../../../redux/types/subvit/subtance-question-detail.type";
import { DELETE_CLONE_SURVEY_QUESTION_BANKS_RESET } from "../../../../../redux/types/subvit/survey-question.type";
...
const StepTwo = ({ token, tokenPermission }) => {
  ...
  useEffect(() => {
    ...
    if (isDeleted) {
      ...
      dispatch({
        type: DELETE_CLONE_SURVEY_QUESTION_BANKS_RESET,
      });
    }
  ...
  const handleCheckboxDeleteAll = (e) => {
    if (e.target.checked) {
      let arr = checkedDelete;
      survey_question_detail.list_questions.forEach((row) => {
      ...
      survey_question_detail.list_questions.forEach((row, i) => {
  ...
  const handleDeleteAll = () => {
    ...
    dispatch(deleteCloneSurveyQuestionBanks(data, token, tokenPermission));
  };
                          ...
                          (question, i) => {
                            return (
                              <tr key={question.id}>
                                ...
                                <td className="align-middle">
                                  CC{question.survey_question_bank_id}
                                </td>
                                <td className="align-middle">
                                  {question.question}
                                </td>

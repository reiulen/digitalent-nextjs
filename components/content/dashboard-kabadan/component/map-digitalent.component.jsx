...
import LoadingDashboard from "./loading-dashboard.component";
import LoadingMap from "./loading-map-dashboard";

const MapDigitalent = ({ data = [], loading }) => {
  const dataMap = [
  ...
  return (
    <>
      <div style={{ position: "relative" }}>
                    ...
                    <Popup>
                      <div className="row">
                        <div className="col-md-12 text-left">
                          <p className="fw-600 fz-12 m-0 p-0">
                            {row?.provinsi}
                          </p>
                        </div>
        ...
        {loading && <LoadingMap loading={true} />}
      </div>
    </>
  );
};

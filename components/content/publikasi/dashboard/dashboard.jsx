          ...
          <div className="col-lg-12 col-xxl-12 my-5">
            ...
            <div className="row m-0">
              <CardDashboard
                ...
                color="text-dark"
                icon="mail.svg"
                title="Total Berita yang dibaca"
                muted="Dibaca"
                mutedValue="200k"
              />
              <CardDashboard
                ...
                color="text-white"
                icon="list-white.svg"
                title="Total Artikel yang dibaca"
                muted="Dibaca"
                mutedValue="200k"
              />
              <CardDashboard
                ...
                color="text-white"
                icon="blok4-white.svg"
                title="Jumlah Semua Konten"
                muted="Publish"
                mutedValue="200k"
              />
            </div>
                ...
                <div className="d-flex align-items-center mb-10">
                  ...
                  <div className="d-flex flex-column flex-grow-1 font-weight-bold">
                    <p className="text-dark text-hover-primary mb-1 font-size-lg">
                      Data Peserta DTS yang Lulus
                    </p>
                    <span className="text-muted">
                      Kategori : <span className="text-primary">VGA</span>
                    </span>
                    <span className="text-muted">
                      Created By : <span className="text-primary">Mee</span>
                    </span>
                  </div>
                  {/* <!--end::Text--> */}

        ...
        <div className="card card-custom card-stretch gutter-b">
          ...
          <div className="card-body">
            <div>
              ...
              <div className="form-group">
                <label className="col-sm-4 col-form-label font-weight-bolder">
                  Link URL
                </label>
                <div className={`${styles.judulTambah} col-sm-12`}>
                  <div className="input-group">
                    <input
                      ...
                      onBlur={() =>
                        simpleValidator.current.showMessageFor("url_link")
                      }
                    />
                  </div>
                  {/* {simpleValidator.current.message(
                ...
                <div className="ml-4 row">
                  ...
                  <div>
                    <label htmlFor="inputGroupFile04" className="icon-plus">
                      <Image src={iconPlus} alt="plus" width={60} height={60} />
                    </label>

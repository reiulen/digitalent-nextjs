...
const WizzardPendidikan = dynamic(
  () =>
    import("../../../user-component-new/content/peserta/wizzard/pendidikan"),
  {
...
export default function WizzardPendidikanPage(props) {
  const session = props.session.user.user.data.user;
  return (
    <>
      <Layout title="Pendidikan Peserta - Pelatihan" session={session}>
        <WizzardPendidikan session={session} />
      </Layout>
    </>
  );
}

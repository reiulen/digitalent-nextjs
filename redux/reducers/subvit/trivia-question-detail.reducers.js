...
export const randomTriviaReducer = (state = { random_trivia: [] }, action) => {
  switch (action.type) {
    case TRIVIA_QUESTION_RANDOM_DETAIL_REQUEST:
      return {
        loading: true,
      };

    case TRIVIA_QUESTION_RANDOM_DETAIL_SUCCESS:
      return {
        loading: false,
        random_trivia: action.payload.data,
      };

    case TRIVIA_QUESTION_RANDOM_DETAIL_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
...
export const newTriviaQuestionDetailReducer = (
  state = { trivia_question_detail: {} },
  action
) => {
  switch (action.type) {
...
export const updateTriviaQuestionDetailReducer = (
  state = { trivia_question_detail: {} },
  action
) => {
  switch (action.type) {
...
export const importFileTriviaQuestionDetailReducer = (
  state = { trivia_question_file: {} },
  action
) => {
  switch (action.type) {
...
export const importImagesTriviaQuestionDetailReducer = (
  state = { trivia_question_images: {} },
  action
) => {
  switch (action.type) {

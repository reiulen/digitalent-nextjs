...
export const randomSurveyReducer = (state = { random_survey: [] }, action) => {
  switch (action.type) {
    case SURVEY_QUESTION_RANDOM_DETAIL_REQUEST:
      return {
        loading: true,
      };

    case SURVEY_QUESTION_RANDOM_DETAIL_SUCCESS:
      return {
        loading: false,
        random_survey: action.payload.data,
      };

    case SURVEY_QUESTION_RANDOM_DETAIL_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
...
export const newSurveyQuestionDetailReducer = (
  state = { survey_question_detail: {} },
  action
) => {
  switch (action.type) {
...
export const detailSurveyQuestionDetailReducer = (
  state = { survey_question_detail: {} },
  action
) => {
  switch (action.type) {
...
export const updateSurveyQuestionDetailReducer = (
  state = { survey_question_detail: {} },
  action
) => {
  switch (action.type) {
...
export const importFileSurveyQuestionDetailReducer = (
  state = { survey_question_file: {} },
  action
) => {
  switch (action.type) {
...
export const importImagesSurveyQuestionDetailReducer = (
  state = { survey_question_images: {} },
  action
) => {
  switch (action.type) {

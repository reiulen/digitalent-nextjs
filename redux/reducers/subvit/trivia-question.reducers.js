...
export const allTriviaQuestionBanksReducer = (
  state = { trivia: [] },
  action
) => {
  switch (action.type) {
...
export const newTriviaQuestionBanksReducer = (
  state = { trivia: {} },
  action
) => {
  switch (action.type) {
...
export const detailTriviaQuestionBanksReducer = (
  state = { trivia: {} },
  action
) => {
  switch (action.type) {
...
export const deleteTriviaQuestionBanksReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case DELETE_CLONE_TRIVIA_QUESTION_BANKS_REQUEST:
      return {
        loading: true,
      };

    case DELETE_TRIVIA_QUESTION_BANKS_SUCCESS:
    case DELETE_CLONE_TRIVIA_QUESTION_BANKS_SUCCESS:
      return {
        loading: false,
    ...
    case DELETE_CLONE_TRIVIA_QUESTION_BANKS_RESET:
      return {
        loading: false,
        isDeleted: false,
      };
    ...
    case DELETE_CLONE_TRIVIA_QUESTION_BANKS_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
...
// ======================================================================================================================
export const updateTriviaQuestionBanksPublishReducer = (
  state = { trivia: {} },
  action
) => {
  switch (action.type) {
...
export const allReportTriviaQuestionBanksReducer = (
  state = { trivia: [] },
  action
) => {
  switch (action.type) {
...
export const newCloneTriviaQuestionBanksReducer = (
  state = { trivia: {} },
  action
) => {
  switch (action.type) {
    case NEW_CLONE_TRIVIA_QUESTION_BANKS_REQUEST:
      return {
        loading: true,
      };

    case NEW_CLONE_TRIVIA_QUESTION_BANKS_SUCCESS:
      return {
        loading: false,
        success: action.payload.message,
        trivia: action.payload.data,
    ...
    case NEW_CLONE_TRIVIA_QUESTION_BANKS_FAIL:
      return {
        loading: false,
        error: action.payload,
      };

    case NEW_CLONE_TRIVIA_QUESTION_BANKS_RESET:
      return {
        success: false,
      };

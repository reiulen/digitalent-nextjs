...
export const getDetailPesertaManage =
  (token, id, tokenPermission) => async (dispatch) => {
    try {
      const { data } = await axios.get(
...
export const updatePesertaDts =
  (token, datas, tokenPermission) => async (dispatch) => {
    try {
      const { data } = await axios.post(
        `${process.env.END_POINT_API_SITE_MANAGEMENT}api/participant/update/data-diri`,
        datas,
        {
          headers: {
            authorization: `Bearer ${token}`,
...
export const pindahPelatihan =
  (token, datas, tokenPermission) => async (dispatch) => {
    try {
      const { data } = await axios.post(
        `${process.env.END_POINT_API_SITE_MANAGEMENT}api/participant/update/ubah-pelatihan`,
        datas,
        {
          headers: {
            authorization: `Bearer ${token}`,
...
export const deletePesertaDts = (token, user_id) => async (dispatch) => {
  try {
...
// export const pindahPelatihan = (token, datas) => async (dispatch) => {
//   try {
//     const { data } = await axios.post(
//       `${process.env.END_POINT_API_SITE_MANAGEMENT}api/participant/update/ubah-pelatihan`,
//       datas,

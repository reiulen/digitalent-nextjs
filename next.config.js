module.exports = {
  ...
  env: {
    ...
    END_POINT_API_IMAGE_PUBLIKASI: "https://dts-publikasi-dev.s3.ap-southeast-1.amazonaws.com/",

    //subvit
    END_POINT_API_SUBVIT: "http://dts-subvit-dev.majapahit.id/",
    // END_POINT_API_SUBVIT: "http://api-dts-dev.majapahit.id/subvit/",
    END_POINT_API_IMAGE_SUBVIT: "https://dts-subvit-dev.s3.ap-southeast-1.amazonaws.com/",
    ...
    END_POINT_API_IMAGE_PARTNERSHIP: "http://dts-partnership-dev.s3.ap-southeast-1.amazonaws.com",

    // site management
    END_POINT_API_SITE_MANAGEMENT: "http://api-dts-dev.majapahit.id/sso/",
    END_POINT_API_IMAGE_SITE_MANAGEMENT: "https://dts-publikasi-dev.s3.ap-southeast-1.amazonaws.com/",
    ...
    END_POINT_API_IMAGE_SERTIFIKAT: "https://dts-sertifikat-dev.s3.ap-southeast-1.amazonaws.com/",

    // Beasiswa
    END_POINT_API_IMAGE_BEASISWA: "https://dts-beasiswa-dev.s3-ap-southeast-1.amazonaws.com",

    END_POINT_API_IMAGE_LOGO_MITRA: "https://dts-partnership-dev.s3-ap-southeast-1.amazonaws.com",
  },
};

...
const Berita = () => {
  ...
  const { berita, loading: loadingBerita } = useSelector(
    (state) => state.allBerandaBerita
  );
    ...
    <div>
      ...
      <div className="col-12 mt-5">
        ...
        {activeTitle == "Ada Apa di Digitalent" ? (
          <div className="mt-3">
            Cerita mitra, berita seru, dan Berita terbaru. Baca semua berita
            soal Digitalent di sini.
          </div>
        ) : (
          <div className="mt-3">
      ...
      {/* Filter Button */}
      {kategori ? (
        <div className="row my-5" style={{ overflowX: "hidden" }}>
          <Carousel
            indicators={false}
            nextIcon={false}
            nextLabel={false}
            ...
            <Carousel.Item>
              <div className="d-flex flex-row ml-6">
                {kategoriBerita === "" ? (
                  ...
                  >
                    <div className="my-1 mx-3 py-1 px-3 text-white">Semua</div>
                  </div>
                ) : (
                  <div
                    ...
                    onClick={() => handleFilterKategori("")}
                  >
                    <div className="my-1 mx-3 py-1 px-3 text-muted">Semua</div>
                  </div>
                )}

                {kategori
                  ? kategori.map((el, i) => {
                      return kategoriBerita == el.nama_kategori ? (
                        <div
            ...
            <div className="border rounded-lg p-2 order-1 mb-5">
              <div className="row ">
                ...
                <div className="col-7 my-auto">
                  <h3 className=" font-weight-bolder">Filter</h3>
                </div>
                  ...
                  <div className="col col-7">
                    <div className="row d-flex justify-content-between align-items-center">
                      ...
                      <div className="mr-2">
                        ...
                        <span className="font-weight-bolder">
                          {/* Insert Akademi Here */}| {el.kategori_akademi}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="row my-5">
                      ...
                      <div
                        dangerouslySetInnerHTML={{
                          __html: handleDescToTrim(el.isi_berita),
                        }}
                      />
                    </div>
                    ...
                    <div className="row mb-3 d-flex align-items-center">
                      ...
                      <div className="text-muted col-xl-5 col-12 pl-0">
                        {moment(el.tanggal_publish).format("DD MMMM")} |{" "}
                        {el.dibaca} dibaca
                      </div>

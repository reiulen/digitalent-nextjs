...
const DetailAkademi = ({ session }) => {
  ...
  const { pelatihan } = useSelector((state) => state.allPelatihan);
        ...
        <div className="col-12 col-md-3">
          ...
          <div className="bg-white rounded border">
            <div className="row d-flex align-items-center">
              ...
              <div className="font-weight-bolder">Filter</div>
            </div>

            <div className="my-5 p-3">
              <div className="font-weight-bolder">Penyelenggara</div>
              <select className="form-control">
                <option value="Semua Penyelenggara" selected>
                  Semua Penyelenggara
                </option>
            ...
            <div className="my-5 p-3">
              <div className="font-weight-bolder">Kategori Peserta</div>
              <select className="form-control">
                <option value="Peserta Umum" selected>
                  Peserta Umum
                </option>
            ...
            <div className="my-5 p-3">
              <div className="font-weight-bolder">Kata Kunci</div>
              <TagsInput
            ...
            pelatihan.list.map((el, i) => {
              return showDetail[i] === false ? (
                  ...
                  >
                    ...
                    <Card.Body className="position-relative">
                      <div className={style.bungkus_mitra_pelatihan}>
                        {el.gambar_mitra !== "" ||
                        el.gambar_mitra !== null ||
                        el.gambar_mitra !== undefined ? (
                          <Image
                            src={
                ...
                <div className="row">
                  <div
                    key={i}
                    className=" row rounded border shadow ml-3 mt-3"
                    style={{ height: "50vh" }}
                  >
                    <div className="col-4">
                      {/* <Image 
                    ...
                    <div className="col-8 mb-0">
                      <Card.Body>
                        <div className="row">
                          ...
                          <div className="col-9">
                            <div className="text-muted">{akademi.name}</div>
                            <div>
                              <h4>{el.name}</h4>
                            </div>
                            <div className="text-info">{el.mitra}</div>
                          </div>
                          <div className="col-1" style={{ cursor: "pointer" }}>
                            <i
                              className="ri-close-fill font-weight-bolder text-dark"
                        ...
                        <div className="row d-flex justify-content-between mt-3">
                          ...
                          <div className="d-flex align-content-center">
                            ...
                            <span className="mt-1">Lokasi: {el.alamat}</span>
                          </div>
                        </div>
                      </Card.Body>
                      <hr />
                        ...
                        {el.status !== "Closed" ? (
                          <div className="col-12 col-md-6 mt-5">
                            ...
                            <button
                              ...
                              onClick={() =>
                                handleCheckPelatihanReg(el.id, session)
                              }
                            >
                              Daftar Pelatihan
                            </button>

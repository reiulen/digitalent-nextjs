...
export default function TidakLulus() {
  return (
    <div>
      <Col lg={12} className="order-1 px-0 h-100">
        <Card className="card-custom card-stretch gutter-b p-0 ">
          <Button variant="white" disabled className="p-0">
              ...
              <Col md={9} className="px-10">
                <Row className="d-flex ">
                  ...
                  <Col lg={2} className="p-0 d-flex justify-content-end">
                    <span
                      className="label label-inline label-light-danger px-4 font-weight-bold p-0"
                ...
                <Row className="my-10">
                  ...
                  <Col md={12} className="d-flex align-items-center mb-8">

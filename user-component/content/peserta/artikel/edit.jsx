                    ...
                    <div className="card-body">
                        <form>
                            <div className="form-group">
                                ...
                                <div className={`${styles.resolusiTambah} mt-3 col-8 col-sm-6 col-md-4 col-lg-5 col-xl-4 text-muted`}>
                                    <p>
                            ...
                            <div className="form-group row mr-0">
                                ...
                                <div className="col-sm-10 text-right">
                                    ...
                                    <button className={`${styles.btnSimpan} btn btn-primary-rounded-full rounded-pill btn-sm border-0`} style={{ backgroundColor: '#007cff' }}>Ubah</button>
                                </div>
                            </div>

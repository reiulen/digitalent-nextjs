              ...
              <div className="row">
                ...
                <div className="d-flex flex-column ml-3">
                  ...
                  <div className="text-muted">
                    {moment(
                      detailArtikelsPeserta.artikel.data.role[0].created_at
                    ).format("DD MMMM YYYY")}
                  </div>
                </div>
              </div>
            ...
            <div className="col-12 col-md-12">
              ...
              <Image
                src={
                  ...
                  "publikasi/images/" +
                  detailArtikelsPeserta.artikel.data.foto
                }
                width="1500vw"
                height="1000vh"
                objectFit="fill"
              ...
              {/* Artikel */}
              <div className="border rounded-lg mb-5 mt-10">
                <div
                ...
                >
                  <div
                    dangerouslySetInnerHTML={{
                      __html: detailArtikelsPeserta.artikel.data.isi_artikel,
                    }}
                  ></div>
                </div>
                  ...
                  <div className="row d-flex ml-3 justify-content-between">
                    {detailArtikelsPeserta.artikel.data.tag?.map(
                      (item, index) => {
                        return (
                          <div
                            className="mr-3 mt-2 border p-3 rounded"
                            key={index}
                          >
                            #{item}
                          </div>

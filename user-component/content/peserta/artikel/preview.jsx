        ...
        <div className="card card-custom card-stretch gutter-b px-10 py-8">
          ...
          {detailArtikelsPeserta ? (
            <div className="row my-5 flex-column">
              <div className="ml-2">
                <div className="badge badge-light mr-2" style={{ fontSize: '12px' }}>
                  <div className="text-primary">{(detailArtikelsPeserta.artikel.data.nama_kategori).toUpperCase()}</div>
                </div>
              </div>
              <div className="mt-5 ml-3">
                <h1 className="" style={{ fontSize: '40px', fontWeight: '700' }}>
                  {/* Insert Title Here */}
              ...
              <div className="mt-5 ml-5 d-flex flex-row align-items-center justify-content-between mx-3">
                <div className="row">
                  <div className="ml-2">
                    ...
                    {
                      detailArtikelsPeserta.artikel.data.role[0].name !== "Peserta" || typeof artikel.role !== "string" ?
                        <Image
                          src={
                            imageLogo
                          }
                  ...
                  <div className="d-flex flex-column ml-3">
                    ...
                    <div className="text-muted">
                      {moment(detailArtikelsPeserta.artikel.data.tanggal_publish).format("DD MMMM YYYY")}
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="my-5 mx-5 text-justify" style={{ width: '96%' }}>
                    {
                      resultText ?
                        ...
                        :
                        <div dangerouslySetInnerHTML={{ __html: detailArtikelsPeserta.artikel.data.isi_artikel }} />
                    }
                  </div>

                  <div className="row m-3 d-flex justify-content-between pb-5">
                    <div className="row d-flex justify-content-between ml-3">
                      {detailArtikelsPeserta && detailArtikelsPeserta.artikel.data.tag && detailArtikelsPeserta.artikel.data.tag.length !== 0
                        ? detailArtikelsPeserta.artikel.data.tag.map((el, i) => {
                          return (
                            <div className="mr-3 border p-3 rounded" style={{ fontSize: '11px' }} key={i}>
                              #{(el).toUpperCase()}
                            </div>
                          );
                        })
